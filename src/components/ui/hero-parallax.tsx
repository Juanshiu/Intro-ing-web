...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className=" h-[250vh] md:h-[300vh] md:py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-200">
        En este siglo, la tecnología ha avanzado rápidamente, cambiando la manera en que vivimos, aprendemos y nos comunicamos. Nuevos dispositivos, herramientas y sistemas han transformado la vida cotidiana y continúan evolucionando día a día.
      </p>
    </div>
  );
};
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-72 w-88 lg:h-96 lg:w-[30rem] relative shrink-0"
    >
      <a
        href={linkUrl}
